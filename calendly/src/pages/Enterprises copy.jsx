          ...
          <Row className="col-md mrqee">
            ...
            <marquee behavior="scroll" direction="left">
              <div className="d-flex aliglogos">
                ...
                <div className="imgscroll">
                  {" "}
                  <img src="img/Twilio-logo-red.svg" alt="" />{" "}
                </div>
                <div className="imgscroll">
                  {" "}
                  <img src="img/zenefits.svg" alt="" />{" "}
                </div>
              </div>
            </marquee>
          </Row>
            ...
            <div className="d-flex mt-4">
              <Col md="4">
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Img variant="top" src="img/Homepage-Hero.webp" />
                  <Card.Body>
                    <Card.Text>
              ...
              <Col md="4">
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Img variant="top" src="img/Teams_Hero.webp" />
                  <Card.Body>
                    <Card.Text>
